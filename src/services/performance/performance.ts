...
export async function getPerformancePage(pageParams: PageParams, orders?: Orders | undefined | null, options?: Record<string, any>) {
  return request<ResultBody<Page<PerformanceVO>>>('/performance/page', {
    method: 'GET',
    params: {
      ...pageParams,
      ...orders,
...
export async function getPerformanceById(performanceId: number, options?: Record<string, any>) {
  return request<ResultBody<PerformanceVO>>(`/performance/${performanceId}`, {
    method: 'GET',
    ...(options || {}),
  });
}
...
export async function addPerformance(body: PerformanceForm, options?: Record<string, any>) {
  return request<ResultBody<number>>('/performance', {
    method: 'POST',
    headers: {
...
export async function deletePerformance(performanceId: number, options?: Record<string, any>) {
  return request<ResultBody<number>>(`/performance/${performanceId}`, {
    method: 'DELETE',
    ...(options || {}),
  });
}
...
export async function batchDeletePerformance(body: number[], options?: Record<string, any>) {
  return request<ResultBody<number[]>>('/performance', {
    method: 'DELETE',
    headers: {
      'Content-Type': 'application/json',
...
export async function printPerformance(performanceId: number, options?: Record<string, any>) {
  return request<any>('/performance/print', {
    method: 'GET',
    ...(options || {}),
  });
}
...
export async function exportPerformance(
  ...
  return request<any>('/performance/export', {
    method: 'GET',
    params: {
      ...params,
    },
