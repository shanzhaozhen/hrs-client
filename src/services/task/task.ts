...
export async function getTaskPage(pageParams: PageParams, orders?: Orders | undefined | null, options?: Record<string, any>) {
  return request<ResultBody<Page<TaskVO>>>('/hrs-api/task/page', {
    method: 'GET',
    params: {
      ...pageParams,
      ...orders,
...
export async function addTask(body: TaskForm, options?: Record<string, any>) {
  return request<ResultBody<number>>('/hrs-api/task', {
    method: 'POST',
    headers: {
...
export async function deleteTask(taskId: number, options?: Record<string, any>) {
  return request<ResultBody<number>>(`/hrs-api/task/${taskId}`, {
    method: 'DELETE',
    ...(options || {}),
  });
}
...
export async function getTaskById(taskId: number, options?: Record<string, any>) {
  return request<ResultBody<TaskVO>>(`/hrs-api/task/${taskId}`, {
    method: 'GET',
    ...(options || {}),
  });
}
...
export async function runTask(taskId: number, options?: Record<string, any>) {
  return request<ResultBody<any>>(`/hrs-api/task/${taskId}/run`, {
    method: 'GET',
    ...(options || {}),
  });
}
...
export async function stopTask(taskId: number, options?: Record<string, any>) {
  return request<ResultBody<number>>(`/hrs-api/task/${taskId}/stop`, {
    method: 'GET',
    ...(options || {}),
  });
}
...
export async function startTask(taskId: number, options?: Record<string, any>) {
  return request<ResultBody<undefined>>(`/hrs-api/task/${taskId}/start`, {
    method: 'GET',
    ...(options || {}),
  });
}
