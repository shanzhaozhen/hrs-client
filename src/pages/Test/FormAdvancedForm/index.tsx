...
const FormAdvancedForm: FC<FormAdvancedFormProps> = ({ submitting, dispatch }) => {
  ...
  const onFinish = (values: Record<string, any>) => {
    setError([]);
    dispatch({
      type: 'testAndFormAdvancedForm/submitAdvancedForm',
      payload: values,
    });
  };
...
export default connect(({ loading }: { loading: { effects: Record<string, boolean> } }) => ({
  submitting: loading.effects['testAndFormAdvancedForm/submitAdvancedForm'],
}))(FormAdvancedForm);
